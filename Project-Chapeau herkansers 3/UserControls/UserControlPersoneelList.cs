...
{
    public partial class UserControlPersoneelList : UserControl
    {
        private Form1 form;
        private PersoneelService personeelService;
        public UserControlPersoneelList()
        {
            InitializeComponent();
        ...
        {
            this.form.SwitchPanels(new UserControlPersoneel(new Personeel(), false));
        }
        ...
        private void AdjustSelectedPersoneel(Personeel personeel)
        {
            ...
            this.form.SwitchPanels(new UserControlPersoneel(personeel, true));
        }
